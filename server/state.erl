...
gameManager(Estado)->
    receive
       ...
       {leave, _} ->
            io:format("Jogador saiu, terminando o jogo.~n"),
...
handle_bordas_bullets_collisions(Bullets, CollisionsBulletsBorder) ->
   ...
   case CollisionsBulletsBorder of
        [] -> ok;
        _  -> io:format("Colisao de bala com a borda: ~p~n", [CollisionsBulletsBorder])
    end,
...
handle_bullet_collisions(Players, Bullets, CollisionsBullets) ->
    case CollisionsBullets of
        [] -> ok;
        _  -> io:format("Colisoes de players com bala: ~p~n", [CollisionsBullets])
    end,
